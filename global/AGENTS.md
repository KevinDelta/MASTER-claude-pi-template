...
<!-- INSTALL: install.sh builds ~/.openclaw/workspaces/<domain>/AGENTS.md by combining this file with domain/AGENTS.md.
     ...
     AGENTS.md there:
       1. Global+Domain -> ~/.openclaw/workspaces/<domain>/AGENTS.md
