...
To use one: copy the file to `~/.openclaw/workspace/SOUL.md`, replace the name and domain, then rewrite voice/identity to match the actual worker's stance. Don't ship the example unchanged.
